...
ChatUtils:AddTrans("ruRU", "LID_SHOWRACEICON", "Показывать значок расы")
ChatUtils:AddTrans("ruRU", "LID_SHOWITEMICON", "Показывать значок предмета")
ChatUtils:AddTrans("ruRU", "LID_SHOWGOLDICON", "Показывать значок золота")
ChatUtils:AddTrans("ruRU", "LID_SHOWSILVERICON", "Показывать значок серебра")
ChatUtils:AddTrans("ruRU", "LID_SHOWCOPPERICON", "Показывать значок меди")
